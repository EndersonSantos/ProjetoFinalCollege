...
# Import the function
from projetofinal.preprocessing import map_dict, encode_target, compute_avg_embedding, embbeded_model, embedded_data, save_as_pickle
...
def sample_data2():
    data = {
        'DescricaoInstrumento': ['This is a test description.', 'Another description here.']
    }
    return pd.DataFrame(data)
...
def sample_data3():
    data = {
        'tokenized_Descricao_text': [['this', 'is', 'a', 'test'], ['another', 'description']],
